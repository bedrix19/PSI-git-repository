...
public class RandomAgent extends Agent {
    private static final String[] ACTIONS = {"C", "D"};
    ...
    protected void setup() {
        ...
        addBehaviour(new CyclicBehaviour() {
            ...
            public void action() {
                ...
                if (msg != null && msg.getPerformative() == ACLMessage.REQUEST && msg.getContent().equals("Action")) {
                    // Elegir una acción aleatoria y enviar la respuesta al MainAgent
    ...
    @Override
    protected void takeDown() {
        System.out.println("RandomAgent " + getAID().getName() + " terminating.");
    }
}
*/