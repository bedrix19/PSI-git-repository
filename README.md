...
- To compile:   javac -d bin -cp .;jade.jar src/*.java src/agents/*.java
- To execute:   java -cp bin;jade.jar jade.Boot -notmp -gui -agents "MainAgent:MainAgent;agent1:agents.RandomAgent;agent2:agents.RandomAgent;agent3:agents.RL_Agent;agent4:agents.NN_Agent;agent5:agents.PSI_4"
